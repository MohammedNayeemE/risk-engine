...
from engine.nodes.etl_nodes import (
    age_agent,
    agentic_chunker,
    dosage_agent,
    identity_agent,
...
# Individual agents route back to validation via dynamic routing in route_chunks
# All agents converge at validate_schema after processing
builder.add_edge("identity_agent", "validate_schema")
builder.add_edge("strength_agent", "validate_schema")
builder.add_edge("dosage_agent", "validate_schema")
builder.add_edge("age_agent", "validate_schema")
builder.add_edge("regulatory_agent", "validate_schema")
